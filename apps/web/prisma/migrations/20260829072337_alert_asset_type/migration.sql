...
INSERT INTO "new_Alert" ("createdAt", "enabled", "id", "kind", "lastBarTime", "lastEvaluated", "params", "portfolioId", "symbol", "timeframe", "updatedAt") SELECT "createdAt", "enabled", "id", "kind", "lastBarTime", "lastEvaluated", "params", "portfolioId", "symbol", "timeframe", "updatedAt" FROM "Alert";
DROP TABLE "Alert";
